const zhHans = {
  ...
  broadcast: {
    ...
    toasts: {
      ...
      groupNameAdded: '已添加群名称：{{name}}',
      groupNameExists: '群名称“{{name}}”已存在',
      groupNameRequired: '请输入群名称',
      groupNameReloadMissing:
        '已添加群名称“{{name}}”，但刷新后的群列表未包含该名称，请稍后重试。',
      groupNamesSynced:
        '群列表已同步：扫描 {{scanned}} 个，新增 {{inserted}} 个，更新 {{updated}} 个，未变更 {{unchanged}} 个',
