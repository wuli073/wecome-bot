const zhHans = {
  ...
  bots: {
    ...
    sessionMonitor: {
      ...
      databaseComposer: {
        ...
        clear: '清空',
        confirmDeleteDescription: '永久删除当前持久化草稿后无法恢复，确认继续吗？',
  ...
  mcp: {
    ...
    builtinConnectorDescription:
      '由 LangBot 管理的本地连接器，仅支持 Windows 开发机，名称、URL 和模式均已锁定。',
    builtinLockedHint:
      '这是 LangBot 管理的内置连接器。你可以启用或停用它，但不能修改名称、URL、模式，也不能删除。',
    detectClient: '检测客户端',
  ...
  databaseMode: {
    ...
    notConfiguredDescription: '请先完成企业微信本地 Connector 配置，再使用数据库模式。',
    goToConnector: '前往企业微信 Connector',
    monitorStoppedTitle: 'Monitor 未启动',
    monitorStoppedDescription: '启动企业微信 Monitor 后，数据库消息才会进入工作台。',
    monitorErrorTitle: 'Monitor 异常',
    monitorErrorDescription: '企业微信 Monitor 出现异常，请前往 Connector 页面查看详情。',
    warmupTitle: '首次预热中',
