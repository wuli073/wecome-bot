const jaJP = {
  ...
  broadcast: {
    ...
    drafts: {
      ...
      pasteToInput: '入力欄に書き込む',
      rewriteToInput: '再度入力欄に書き込む',
      pasteLoading: '書き込み中...',
      messageBody: 'ドラフト本文',
    ...
    logs: {
      ...
      booleanYes: 'はい',
      booleanNo: 'いいえ',
      statusDraftWritten: '入力欄へ書き込み済み',
      statusPasteVerified: '入力欄に書き込み・検証済み',
      statusWarning: '書き込み済み、送信前に手動確認してください',
      statusSendTriggered: '送信トリガー済み',
      fields: {
        attachmentCount: '添付数',
        attachmentNames: '添付名',
